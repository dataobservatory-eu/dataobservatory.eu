...
<td style="text-align: center;">{{< figure src="/media/img/blogposts_2021/Gold_panning_at_Bonanza_Creek_Edit.png" caption="[Open Data](/post/2021-06-18-gold-without-rush/)</br>Uncut diamonds need to be polished. Data is only potential information, raw and unprocessed." numbered="false" >}}</td>
...
<td style="text-align: center;">{{< figure src="/media/img/blogposts_2020/automated_music_observatory.png" caption="[Automated Data Observatories](/post/2020-09-11-creating-automated-observatory/)</br></br>Reusable, easy-to-import, interoperable, always fresh data in tidy formats with a modern API." numbered="false" >}}</td>
</tr>
<tr>
