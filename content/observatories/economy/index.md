...
{{< icon name="hand-point-right" pack="fas" >}}Get involved in {{< staticref  "/#services" "newtab"  >}}services{{< /staticref >}}: our [ongoing projects](https://economy.dataobservatory.eu//#projects), team of [contributors](https://economy.dataobservatory.eu//#contributors), [open-source libraries](https://economy.dataobservatory.eu//#software) and use our data for publications. See some [use cases](/#featured).
...
{{< icon name="download" pack="fas" >}} Download our {{< staticref "https://economy.dataobservatory.eu//media/presentations/EDO_Datathon_Submission_2021.pdf" "newtab" >}}competition presentation{{< /staticref >}}

Our Product/Market Fit was validated in the world's 2nd ranked university-backed incubator program, the [Yes!Delft AI Validation Lab](https://economy.dataobservatory.eu/post/2020-09-25-yesdelft-validation/).
